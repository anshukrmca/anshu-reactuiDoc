...
import { ECommerceMenuCategories, ECommerceSidebarMenuData } from '../../Data/MenuData';
import BreadcrumbContainer from '../../Layouts/BreadcrumbContainer';
import "../../assets/CSS/DashBoardLayout.css";

type Props = {}

export default function EcomDashBoardLayout({ }: Props) {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <SideBarMenu MenuData={ECommerceSidebarMenuData} CategoriesData={ECommerceMenuCategories} />
                </div>
                ...
                >
                    ...
                    >
                        <div className="flex-1 p-2" style={{ minHeight: "100vh" }}>
                            <div className="my-2"><BreadcrumbContainer Data={ECommerceSidebarMenuData} /></div>
