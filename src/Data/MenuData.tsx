...
export const DocSidebarMenuData: MenuNode[] = [
  { id: 15, icon: <DynamicIcon name="FaBookOpen" />, label: "Documentation", link: '/doc' },
  {
    ...
    label: "Projects",
    children: [
      { id: 101, label: "Sales", link: "sale" },
      { id: 102, label: "Analytics", link: "analytics" },
      { id: 103, label: "Ecommerce", link: "ecommerce" },
      { id: 104, label: "CRM", link: "crm" },
      { id: 105, label: "Crypto", link: "crypto" },
      { id: 106, label: "NFT", link: "nft" },
      { id: 109, label: "HRM", link: "hrm" },
      { id: 110, label: "Courses", link: "courses" },
      { id: 111, label: "Medical", link: "medical" },
    ],
  },
  {
    id: 2,
